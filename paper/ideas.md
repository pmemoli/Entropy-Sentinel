...
### Reward Models for monitoring & improvement.

Tomorrow review literature
...
This in turns provides us with substantive analysis and ablationsin a controlled environment for the design choices in Entropy Sentinel.

(2) Can ES be used for large scale monitoring by learning to score from an external judge?
...
- Review paper MT-Bench llm eval.
...
- Incluir algunas ablaciones simples para estudiar el bias de longitud (puede ser correr un modelo que reciba longitud nomas).
