...
This repository contains the code for reproducing the experiments from the paper ["Entropy Sentinel: Probing Entropy Traces for LLM Monitoring"](https://arxiv.org/abs/2601.09001).
